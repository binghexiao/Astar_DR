...
void MultihierarchyVsOrdinary() {
    ...
    //用于统计参数数据
    ofstream log("D:/桌面/statics_DR.txt");
    //基准格网层级
    int level = 10;
    //多层次格网层级
    int target_level = 16;
...
void MultiObjectVsSingleObject() {
    ...
    //用于统计参数数据
    ofstream log("D:/桌面/statics_DR.txt",ios::app);
    //基准格网层级
    int level = 10;
    //多层次格网层级
    int target_level = 16;
    ...
    // string filepath = "D:/桌面/数据3000.csv";
    // string filepath = "D:/桌面/数据5000.csv";
    ...
    // 多粒度模型
    // // 深度 = 10 
    // H3Index h3_start = 0x8a4008174407fff;
    // H3Index h3_end = 0x8a4008176d6ffff;

    // 超小数据的起始点
    // H3Index h3_start = 0x8a4008174407fff;
    // H3Index h3_end = 0x8a400812b04ffff;
    ...
    // d = 40
    // H3Index h3_start = 0x8a4008174407fff;
    // H3Index h3_end = 0x8a400810c957fff;
    // 3000数据起点 d = 60
    // H3Index h3_start = 0x8a4008174407fff;
    // H3Index h3_end = 0x8a400810115ffff;
    // 改正后的d=60
    // H3Index h3_start = 0x8a4008174d0ffff;
    // H3Index h3_end = 0x8a4008105357fff;
    //  5000数据 d = 80
    // H3Index h3_start = 0x8a4008174407fff;
    // H3Index h3_end = 0x8a4008103927fff;
    // 新的 d= 80
    // H3Index h3_start = 0x8a400817610ffff;
    // H3Index h3_end = 0x8a4008103537fff;
    // 8000   d = 100
    H3Index h3_start = 0x8a4008174407fff;
    H3Index h3_end = 0x8a400810208ffff;
    // 10000  d = 120
    /*H3Index h3_start = 0x8a40088dc527fff;
    H3Index h3_end = 0x8a40081350cffff;*/
     //部分数据的开始点和结束点
    /*H3Index h3_start = 0x8a4008b9d897fff;
    H3Index h3_end = 0x8a4008b9855ffff;*/
    ...
    log << "COSTS支配检查次数：" << Util::cost_check_cnt << endl;
    cout << "COSTS支配检查次数：" << Util::cost_check_cnt << endl;
    log << "Gcl支配检查次数：" << Util::cl_check_cnt << endl;
    cout << "Gcl支配检查次数：" << Util::cl_check_cnt << endl;
    log << "Gop支配检查次数：" << Util::op_check_cnt << endl;
    cout << "Gop支配检查次数：" << Util::op_check_cnt << endl;
    ...
    ofstream outfile("D:/桌面/geojson_DR/DR_d=100.geojson");
    outfile << Util::getGeoJson(result, "多粒度");
    outfile.close();
    /*cout << "普通：" << endl;
    auto time = Util::PrintCurrentTime();
...
int main()
{
    ...
    cout << "Util::cost_check_cnt" << Util::cost_check_cnt << endl;
    cout << "Util::clt_check_cnt" << Util::cl_check_cnt << endl;
    // by xgg
    //array_type g_m({ 1, 2 });
    ////cout << g_m[0] << endl;
    ////cout << g_m[1] << endl;
